  ...
  return (
    <section id="hero" className="relative w-full h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${HeroImage})` }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6">
        <h1 className="text-5xl font-bold mb-4 font-playfair">{content[language].title}</h1>
        <p className="text-2xl mb-8">{content[language].subtitle}</p>
        <button onClick={() => handleScrollTo('service')} className="px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-full text-lg font-semibold transition duration-300 ease-in-out">
